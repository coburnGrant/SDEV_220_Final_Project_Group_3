...
const ShipmentList = ({ shipments, onViewDetails, onDelete }) => {
    return (
            ...
            {shipments.length === 0 ? (
                ...
                <table className="w-full">
                    <thead>
                        ...
                        <th className="py-3 px-4 text-left font-semibold text-gray-600">Tracking Number</th>
                        <th className="py-3 px-4 text-left font-semibold text-gray-600">Status</th>
                        <th className="py-3 px-4 text-left font-semibold text-gray-600">Carrier</th>
                        <th className="py-3 px-4 text-left font-semibold text-gray-600">Estimated Arrival</th>
